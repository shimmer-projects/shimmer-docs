...
**[➜](https://www.oracle.com/java/technologies/javase/16-relnotes.html#JDK-8253415) JEP 393: Foreign-Memory Access API (Third Incubator)**

Introduce an API to allow Java programs to **safely and efficiently access foreign memory** outside of the Java heap.

For further details, see [JEP 393](https://openjdk.java.net/jeps/393).
